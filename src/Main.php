...
$svnlist = simplexml_load_file('http://barril1.projects.cs.illinois.edu/svn_list.xml')
or die('unable to load svn list');

$svnlog = simplexml_load_file('http://barril1.projects.cs.illinois.edu/svn_log.xml')
