...
$svnlist = simplexml_load_file('http://barril1.projects.cs.illinois.edu/SE_list.xml')
or die('unable to load svn list');

$svnlog = simplexml_load_file('http://barril1.projects.cs.illinois.edu/SE_log.xml')
